...
void dns_full_name_to_wire(dns_name_pointer_t *NULLABLE r_pointer,
                           dns_transaction_t *NONNULL txn,
                           const char *NONNULL name);
void dns_name_plus_ptr_to_wire(dns_name_pointer_t *NULLABLE r_pointer,
                               dns_transaction_t *NONNULL txn,
                               const char *NONNULL name,
...
void dns_ttl_to_wire(dns_transaction_t *NONNULL txn,
                     int32_t val);
void dns_rdlength_begin(dns_transaction_t *NONNULL txn);
void dns_rdlength_end(dns_transaction_t *NONNULL txn);
void dns_rdata_a_to_wire(dns_transaction_t *NONNULL txn,
